...
int main(){
    ...
    //int** table = new int*[row_count][column_count]; will not give us what we want because it would give 2D array of pointers. we don't need that
    ...
    for(int r = 0;r<row_count;r++){
        for(int c = 0;c<column_count;c++){
            //can make val depend on the row easilyy using ternary
